...
const instructionPrompt = `あなたはGitHubリポジトリを解析して、Cline AIアシスタントのためのルールセット（チートシート）を生成するエージェントです。
...
8. 収集した情報を元にCline Rulesチートシートを作成する
...
// 単一のCline Rules生成エージェント
export const clineRulesAgent = new Agent({
    name: "Cline Rules生成エージェント",
